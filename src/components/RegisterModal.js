            ...
            <div className="container mx-auto mt-8">
                <form onSubmit={handleSubmit} className="">
                    ...
                    <div className="mb-4">
                        ...
                        />
                        <span className="text-blue-500">{formError.fullName}</span>
                    </div>
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            className="w-full px-4 py-2 border rounded-md focus:outline-none focus:border-slate-900"
                        />
                        <span className="text-blue-500">{formError.phoneNumber}</span>
                    </div>
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            className="w-full px-4 py-2 border rounded-md focus:outline-none focus:border-slate-900"
                        />
                        <span className="text-blue-500">{formError.email}</span>
                    </div>
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            className="w-full px-4 py-2 border rounded-md focus:outline-none focus:border-slate-900"
                        />
                        <span className="text-blue-500">{formError.password}</span>
                    </div>
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            className="w-full px-4 py-2 border rounded-md focus:outline-none focus:border-slate-900"
                        />
                        <span className="text-blue-500">{formError.confirmPassword}</span>
                    </div>

                    <button type="submit" className="px-4 py-2 bg-blue-700 text-slate-100 rounded-md hover:bg-blue-800">
                        Register
                    </button>
                </form>
            </div>
